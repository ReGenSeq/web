...
export function ResourcesSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      id="resources" 
      className="h-screen flex items-start lg:items-center snap-start snap-always overflow-hidden"
    >
      <div 
        className="max-w-7xl mx-auto px-4 md:px-8 w-full pt-32 lg:pt-0"
        style={{
